...
<html lang="en">
    <head>
    <title>Mitchell Saulsberry's Two examples of web cams</title>
...
<div class="wrapper">
    <header>
      <h1><a href="index.php"><i class="logo fa fa-video-camera"></i> Mitchell Saulsberry: Web Dev Examples</a></h1>
      <nav id="cssmenu">
          <ul>
    ...
    <!-- START LEFT COL -->
    <section>
     <h2 class="pageID">Two examples of web cams</h2>
     <!-- END header.php include here! -->    
    <div class='embed-container'>
        <p><iframe width="560" height="315" src="https://www.youtube.com/embed/XbZjFCGZ1Mc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></p>
        </div>
    ...
    <aside>
      ...
      <div class="embed-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/AbTrGcHWOWA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </aside>
    <!-- END RIGHT COL -->
